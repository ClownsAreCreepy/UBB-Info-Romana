...
import domain.user.FlyingDuck;
import domain.user.HybridDuck;
import domain.user.SwimmingDuck;
import service.*;
...
public class Console {
    ...
    public Console(UserService users, FriendshipService friends, CommunityService community, CardService cards) {
        this.users = users;
