...
public class MovieController implements Observer<EntityChangeEvent> {
    ...
    private void initYearsCombo() {
        var years = movieService.getYears(); //adauga doar anii distincti
        years.addFirst(null); //apare "nimic" - Years
    ...
    private void initModel() {
        Page<Movie> page = movieService.findAllOnPage(new Pageable(currentPage, pageSize));
