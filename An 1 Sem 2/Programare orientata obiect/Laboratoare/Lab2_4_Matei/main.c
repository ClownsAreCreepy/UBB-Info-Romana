...
Creati o aplicatie care permite:
 ...
 e) Vizualizare lista de medicamente filtrate dupa un criteriu. Medicamente unde stocul disponibil
    este mai mic decat o valoare data; medicamente cu numele incepand cu o litera data.
*/

int main() {
  ruleaza_toate_testele();
  ui_ruleaza_aplicatie();;
  return 0;
}