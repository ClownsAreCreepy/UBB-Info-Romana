...
class Program
{
    ...
    private static IRepository<string, Angajat> AngajatiFileIO(bool test = false)
    {
        ...
        IRepository<string, Angajat> angajatRepo = new AngajatInFileRepo(validator, fileName2);
    ...
    private static IRepository<string, Sarcina> SarciniFileIO(bool test = false)
    {
        ...
        IRepository<string, Sarcina> sarciniRepo = new SarciniInFileRepo(validator, fileName2);
         ...
         bool test = false)
     {
         ...
         IRepository<string, Pontaj> pontajRepo = new PontajInFileRepo(validator, fileName2, angajatRepo, sarciniRepo);
